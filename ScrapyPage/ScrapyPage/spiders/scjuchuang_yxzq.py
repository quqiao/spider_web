...
class ExampleLoginSpider(scrapy.Spider):
    ...
    def login(self):
        ...
        username = self.driver.find_element_by_class_name('loginName')
        password = self.driver.find_element_by_class_name('loginPassword')
    ...
    def start_requests(self,):
        yxzq = 'https://www.scjuchuang.com/goods?attr=1&page=1'
